  ...
  <div class="container-fluid">
    ...
    <br />
		...
		<ul class="nav nav-tabs">
			<li class="active"><a href="#tab-extensions" data-toggle="tab"><?php echo KaGlobal::t('Extensions'); ?></a></li>
<?php /*			
			<li><a href="#tab-upgrades" data-toggle="tab"><?php echo KaGlobal::t('Upgrades'); ?></a></li>
*/ 
?>			
		</ul>
