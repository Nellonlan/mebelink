	...
	public function addOrderHistory($order_id, $order_status_id, $comment = '', $notify = false, $override = false) {
		...
		if ($order_info) {
			...
			if (!$order_info['order_status_id'] && $order_status_id) {
				...
				if ($this->config->get('s_testimonial_status') && $this->config->get('s_testimonial_link_order')) {
				...
				if ($this->config->get('s_testimonial_status') && $this->config->get('s_testimonial_link_order')) {
					$data['text_testimonial'] = $language->get('text_testimonial');
				}
				...
				if ($this->config->get('s_testimonial_status') && $this->config->get('s_testimonial_link_order')) {
					$text .= $language->get('text_testimonial') . "\n" . $order_info['store_url'] . "index.php?route=information/testimonial\n\n";
				}
