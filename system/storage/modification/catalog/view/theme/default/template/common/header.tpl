<!DOCTYPE html>
<!--[if IE]><![endif]-->
<!--[if IE 8 ]><html <?php echo $tc_og_prefix; //microdatapro 7.5 ?> dir="<?php echo $direction; ?>" lang="<?php echo $lang; ?>" class="ie8"><![endif]-->
<!--[if IE 9 ]><html <?php echo $tc_og_prefix; //microdatapro 7.5 ?> dir="<?php echo $direction; ?>" lang="<?php echo $lang; ?>" class="ie9"><![endif]-->
<!--[if (gt IE 9)|!(IE)]><!-->
<html <?php echo $tc_og_prefix; //microdatapro 7.5 ?> dir="<?php echo $direction; ?>" lang="<?php echo $lang; ?>">
<!--<![endif]-->
<head>
<meta charset="UTF-8" />
...
<?php } ?>
<?php echo $tc_og; $microdatapro_main_flag = 1; //microdatapro 7.5 - 1 - main ?>
...
.catalog-section__caption{border-top:1px solid #dfdcdc;padding:10px;text-align:center;font-weight:100}
</style>
...
<?php if(!isset($microdatapro_main_flag)){echo $tc_og;} //microdatapro 7.5 - 2 - extra ?>
...
<li class="inform"><a href="/index.php?route=information/contact">Написать отзыв</a></li>
	  ...
	  <div class="envelope-header"><a href="mailto:mebeldk@inbox.ru" style="color: #101010;"><i class="fa fa-envelope-o"></i>mebeldk@inbox.ru</a></div>
				...
				<?php if ($config_viber_tel) { ?>
				<div id="viber-callme">
					<div id="viber-callme-main"></div>
					<div id="viber-callme-circle"></div>
					<div id="viber-callme-circle-2"></div>
					<a href="viber://send?number=+<?php echo preg_replace('/[^0-9]/', '', $config_viber_tel) ?>">
						<div id="viber-callme-phone"></div>
					</a>
				</div>
				<?php } ?>
				<?php if ($config_whatsapp_tel) { ?>
				<div id="whatsapp-callme">
					<div id="whatsapp-callme-main"></div>
					<div id="whatsapp-callme-circle"></div>
					<div id="whatsapp-callme-circle-2"></div>
					<a href="whatsapp://send?phone=+<?php echo preg_replace('/[^0-9]/', '', $config_whatsapp_tel) ?>">
