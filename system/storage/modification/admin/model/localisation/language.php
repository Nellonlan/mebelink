...
class ModelLocalisationLanguage extends Model {
	public function addLanguage($data) {
		...
		if ($this->config->get('cpt_installed')) {
			...
			$cpt_settings = $this->model_setting_setting->getSetting('cpt');
			$cpt_settings['cpt_login_required_text'][$language_id] = isset($cpt_settings['cpt_login_required_text'][$this->config->get('config_language_id')]) ? $cpt_settings['cpt_login_required_text'][$this->config->get('config_language_id')] : '';
			$cpt_settings = $this->model_setting_setting->editSetting('cpt', $cpt_settings);
		}
