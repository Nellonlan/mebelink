...
class ControllerCatalogCategory extends Controller {
    ...
    if ($this->config->get('config_editor_default')) {
	    ...
	    $data['entry_rm_description'] = $this->language->get('entry_rm_description');
		$data['entry_hd_description'] = $this->language->get('entry_hd_description');
		$data['entry_ht_description'] = $this->language->get('entry_ht_description');
		$data['entry_ext_description'] = $this->language->get('entry_ext_description');
		$data['entry_rm_ext_description'] = $this->language->get('entry_rm_ext_description');
		$data['entry_rmm_ext_description'] = $this->language->get('entry_rmm_ext_description');
		$data['entry_hd_ext_description'] = $this->language->get('entry_hd_ext_description');
		$data['entry_ht_ext_description'] = $this->language->get('entry_ht_ext_description');

		$data['help_hd_description'] = $this->language->get('help_hd_description');
		$data['help_rm_description'] = $this->language->get('help_rm_description');
		$data['help_ext_description'] = $this->language->get('help_ext_description');
		$data['help_hd_ext_description'] = $this->language->get('help_hd_ext_description');
		$data['help_rm_ext_description'] = $this->language->get('help_rm_ext_description');
		$data['help_rmm_ext_description'] = $this->language->get('help_rmm_ext_description');
