...
if (isset($this->error['autocomplete_limit'])) {
		...
		if (isset($this->request->post['config_image'])) {
			...
			$data['config_image'] = $this->config->get('config_image');
				...
				if (isset($this->request->post['config_viber_tel'])) {
					$data['config_viber_tel'] = $this->request->post['config_viber_tel'];
				} else {
					$data['config_viber_tel'] = $this->config->get('config_viber_tel');
				}
				if (isset($this->request->post['config_whatsapp_tel'])) {
					$data['config_whatsapp_tel'] = $this->request->post['config_whatsapp_tel'];
				} else {
