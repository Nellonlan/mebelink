          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="input-fax"><?php echo $entry_viber; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_viber_tel" value="<?php echo $config_viber_tel; ?>" placeholder="<?php echo $entry_viber; ?>" id="input-fax" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-fax"><?php echo $entry_whatsapp; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_whatsapp_tel" value="<?php echo $config_whatsapp_tel; ?>" placeholder="<?php echo $entry_whatsapp; ?>" id="input-fax" class="form-control" />
                </div>
              </div>
              <div class="form-group">
