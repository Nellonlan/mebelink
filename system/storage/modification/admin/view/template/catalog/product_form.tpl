        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-links" data-toggle="tab"><?php echo $tab_links; ?></a></li>
				...
				<li><a href="#tab-mrp" data-toggle="tab"><?php echo $entry_mrp; ?></a></li>
            ...
            <li><a href="#tab-special" data-toggle="tab"><?php echo $tab_special; ?></a></li>
                    ...
                    <li><a href="#tab_youtube_product_video" data-toggle="tab"><?php echo $tab_youtube_product_video; ?></a></li>
            ...
            <li><a href="#tab-design" data-toggle="tab"><?php echo $tab_design; ?></a></li>
					...
					<!-- XD Stickers start -->
                                ...
                                <!-- OCext Feed Generator Yandex Market -->
				<li><a href="#tab_ocext_feed_generator" data-toggle="tab"><?php echo $tab_ocext_feed_generator; ?></a></li>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
			  ...
			  <div class="form-group">
				<label class="col-sm-2 control-label" for="input-tab<?php echo $tab['tab_id']; ?>-<?php echo $language['language_id']; ?>"><?php echo $tab['name']; ?></label>
				<div class="col-sm-10">
				  <div class="row">
					<div class="col-sm-3 col-lg-2">
					  <select class="tab-status form-control col-sm-" name="product_tab[<?php echo $tab['tab_id']; ?>][status]" data-target="#ctab-<?php echo $tab['tab_id']; ?>-<?php echo $language['language_id']; ?>">
						<option value="1"<?php echo (!isset($product_tab[$tab['tab_id']]['status']) || (int)$product_tab[$tab['tab_id']]['status']) ? ' selected="selected"' : ''; ?>><?php echo $text_enabled; ?></option>
						<option value="0"<?php echo (isset($product_tab[$tab['tab_id']]['status']) && !(int)$product_tab[$tab['tab_id']]['status']) ? ' selected="selected"' : ''; ?>><?php echo $text_disabled; ?></option>
					  </select>
					</div>
				  </div>
				  <div class="row">
					<div class="col-sm-12">
					  <div id="ctab-<?php echo $tab['tab_id']; ?>-<?php echo $language['language_id']; ?>"<?php echo (!isset($product_tab[$tab['tab_id']]['status']) || !(int)$product_tab[$tab['tab_id']]['status']) ? ' style="display:none"' : ''; ?>>
						<textarea name="product_tab[<?php echo $tab['tab_id']; ?>][content][<?php echo $language['language_id']; ?>]" placeholder="<?php echo $entry_description; ?>" id="input-tab<?php echo $tab['tab_id']; ?>-<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($product_tab[$tab['tab_id']]['content'][$language['language_id']]) ? $product_tab[$tab['tab_id']]['content'][$language['language_id']] : ''; ?></textarea>
					  </div>
					</div>
				  </div>
				</div>
...
<?php /* ///karapuz (ka_csv_product_import.ocmod.xml)  */?>
                ...
                <table id="special" class="table table-striped table-bordered table-hover">
                  ...
                  <tfoot>
                    ...
                    <div class="tab-pane" id="tab_youtube_product_video">
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-youtube_product_video"><?php echo $youtube_product_video_link_text; ?></label>
                        <div class="col-sm-10">
                          <input name="youtube_product_video" value="<?php echo $youtube_product_video; ?>" placeholder="<?php echo $youtube_product_video_link_text; ?>" id="input-youtube_product_video" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-2 control-label"><?php echo $youtube_product_video_button_preview; ?></label>
                        <div class="col-sm-10">
                          <span class="btn btn-danger" data-toggle="modal" data-target="#youtube_product_video_modal"><i class="fa fa-play"> <?php echo $youtube_product_video_modal_title; ?></i></span>
                        </div>
                      </div>
                    </div>
                    <!-- YouTube Product Video -- End -->
		...
		<!-- OCext Feed Generator Yandex Market -->
		<div class="tab-pane" id="tab_ocext_feed_generator">
                    <div class="table-responsive">

                      <?php echo $ocext_feed_generator_product_setting; ?>
            ...
            <div class="tab-pane" id="tab-reward">
              ...
              <div class="table-responsive">
				...
				<div class="tab-pane" id="tab-mrp">
					<div class="col-sm-2">
						<ul class="nav nav-pills nav-stacked" id="mrptab">
							<?php $mrp_row = 1; ?>
							<?php foreach ($product_mrps as $product_mrp) { ?>
								<li><a href="#tab-mrptab<?php echo $mrp_row; ?>" data-toggle="tab"><i class="fa fa-minus-circle" onclick="$('a[href=\'#tab-mrptab<?php echo $mrp_row; ?>\']').parent().remove(); $('#tab-mrptab<?php echo $mrp_row; ?>').remove(); $('#mrptab a:first').tab('show');"></i> <?php echo $entry_group . ' ' . $mrp_row; ?></a></li>
							<?php $mrp_row++; ?>
							<?php } ?>
							<li id="mrptab-add"><span onclick="addCustomtab();" class="btn btn-success btn-block "><i class="fa fa-plus-circle"></i> <?php echo $entry_add_table; ?></span></li>
						</ul>
					</div>
					<div class="col-sm-10">
						<div class="tab-content tab-info">
							...
							<?php $mrp_prod_row = 1; ?>
							<?php foreach ($product_mrps as $product_mrp) { ?>
								<div class="tab-pane" id="tab-mrptab<?php echo $mrp_row; ?>">
									<ul class="nav nav-tabs" id="mrp-language<?php echo $mrp_row; ?>">
										<?php foreach ($languages as $language) { ?>
											<li><a href="#tab-mrptab<?php echo $mrp_row; ?>-language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" />  <?php echo $language['name']; ?></a></li>
										<?php } ?>
									</ul>
									<div class="tab-content">
										<?php foreach ($languages as $language) { ?>
											<div class="tab-pane" id="tab-mrptab<?php echo $mrp_row; ?>-language<?php echo $language['language_id']; ?>">
												<div class="form-group">
													<label class="col-sm-2 control-label" for="input-heading<?php echo $mrp_row; ?>-language<?php echo $language['language_id']; ?>"><?php echo $entry_title; ?></label>
													<div class="col-sm-10">
														<input type="text" name="product_mrp[<?php echo $mrp_row; ?>][product_mrp_description][<?php echo $language['language_id']; ?>][title]" value="<?php echo isset($product_mrp['product_mrp_description'][$language['language_id']]) ? $product_mrp['product_mrp_description'][$language['language_id']]['title'] : ''; ?>" class="form-control"/>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-2 control-label" for="input-description<?php echo $mrp_row; ?>-language<?php echo $language['language_id']; ?>"><?php echo $entry_description; ?></label>
													<div class="col-sm-10">
														<textarea name="product_mrp[<?php echo $mrp_row; ?>][product_mrp_description][<?php echo $language['language_id']; ?>][description]" placeholder="<?php echo $entry_description; ?>" id="input-description<?php echo $mrp_row; ?>-language<?php echo $language['language_id']; ?>" data-lang="<?php echo $lang; ?>" class="form-control summernote"><?php echo isset($product_mrp['product_mrp_description'][$language['language_id']]) ? $product_mrp['product_mrp_description'][$language['language_id']]['description'] : ''; ?></textarea>
													</div>
												</div>
											</div>
										<?php } ?>
									...
									<div class="form-group">
										<label class="col-sm-2 control-label" for="input-status<?php echo $mrp_row; ?>"><?php echo $entry_status; ?></label>
										<div class="col-sm-4">
											<select name="product_mrp[<?php echo $mrp_row; ?>][status]" id="input-status" class="form-control">
												<?php if ($product_mrp['status']) { ?>
													<option value="1" selected="selected"><?php echo $text_enabled; ?></option>
													<option value="0"><?php echo $text_disabled; ?></option>
												<?php } else { ?>
													<option value="1"><?php echo $text_enabled; ?></option>
										...
										<label class="col-sm-2 control-label" for="input-sort_order<?php echo $mrp_row; ?>"><?php echo $entry_sort_order; ?></label>
										<div class="col-sm-4">
											<input type="text" name="product_mrp[<?php echo $mrp_row; ?>][sort_order]" value="<?php echo $product_mrp['sort_order']; ?>" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" />
										</div>
									</div>
									<div class="form-group"></div>
									<table id="products<?php echo $mrp_row; ?>" class="table table-striped table-bordered table-hover">
										<thead>
											<tr>
												<td class="text-left"><?php echo $entry_table_product; ?></td>
												<td style="width: 10%;"><?php echo $entry_sorted; ?></td>
												<td style="width: 1px;"></td>
											</tr>
										</thead>
										<tbody>
											<?php foreach ($product_mrp['product_mrp_product'] as $product_mrp_product) { ?>
												<tr id="mrpbox-row<?php echo $mrp_prod_row; ?>">
													<td class="text-left"><input type="hidden" name="product_mrp[<?php echo $mrp_row; ?>][product_mrp_product][<?php echo $mrp_prod_row; ?>][related_id]" value="<?php echo $product_mrp_product['related_id']; ?>" class="form-control" /><input type="text" name="product_mrp[<?php echo $mrp_row; ?>][product_mrp_product][<?php echo $mrp_prod_row; ?>][product_name]" value="<?php echo $product_mrp_product['product_name']; ?>" class="form-control" /></td>
													<td class="text-center"><input type="text" name="product_mrp[<?php echo $mrp_row; ?>][product_mrp_product][<?php echo $mrp_prod_row; ?>][sort_order]" value="<?php echo $product_mrp_product['sort_order']; ?>"  class="form-control text-center" />
													<td class="text-center"><button type="button" onclick="$(this).tooltip('destroy');$('#mrpbox-row<?php echo $mrp_prod_row; ?>').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>
												</tr>
												<?php $mrp_prod_row++; ?>
											<?php } ?>
										</tbody>
										<tfoot>
											<tr>
												<td colspan="2"></td>
												<td class="text-left"><button type="button" onclick="addmrpbox(<?php echo $mrp_row; ?>);" data-toggle="tooltip" title="<?php echo $entry_add_table; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
											</tr>
										</tfoot>
									</table>
								</div>
...
<?php if ($cpt_status) { ?>
<script type="text/javascript"><!--
$('body').on('change', 'select.tab-status', function(e) {
...
<script type="text/javascript"><!--
var mrp_row = <?php echo $mrp_row; ?>;

function addCustomtab() {	
html  = '<div id="tab-mrptab' + mrp_row + '" class="tab-pane">';
html += '  <ul class="nav nav-tabs" id="mrp-language' + mrp_row + '">';
<?php foreach ($languages as $language) { ?>
html += '    <li><a href="#tab-mrptab' + mrp_row + '-language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>';
<?php } ?>
html += '  </ul>';
html += '  <div class="tab-content">';
<?php foreach ($languages as $language) { ?>
html += '    	<div class="tab-pane" id="tab-mrptab' + mrp_row + '-language<?php echo $language['language_id']; ?>">';
html += '      		<div class="form-group">';
html += '        	<label class="col-sm-2 control-label" for="input-title' + mrp_row + '-language<?php echo $language['language_id']; ?>"><?php echo $entry_title; ?></label>';
html += '        	<div class="col-sm-10"><input type="text" name="product_mrp[' + mrp_row + '][product_mrp_description][<?php echo $language['language_id']; ?>][title]" placeholder="<?php echo $entry_title; ?>" id="input-title' + mrp_row + '-language<?php echo $language['language_id']; ?>" value="" class="form-control"/></div>';
html += '      	</div>';
html += '      	<div class="form-group">';
html += '        	<label class="col-sm-2 control-label" for="input-description' + mrp_row + '-language<?php echo $language['language_id']; ?>"><?php echo $entry_description; ?></label>';
html += '        	<div class="col-sm-10"><textarea name="product_mrp[' + mrp_row + '][product_mrp_description][<?php echo $language['language_id']; ?>][description]" id="input-description' + mrp_row + '-language<?php echo $language['language_id']; ?>"></textarea></div>';
html += '      	</div>';
html += '    	</div>';
<?php } ?>
html += '  </div>';
html += '      	<div class="form-group">';
html += '        	<label class="col-sm-2 control-label" for="input-status' + mrp_row +'"><?php echo $entry_status; ?></label>';
html += '        	<div class="col-sm-4"><select name="product_mrp[' + mrp_row + '][status]" class="form-control"><option value="1"><?php echo $text_enabled; ?></option><option value="0"><?php echo $text_disabled; ?></option></select></div>';
html += '			<label class="col-sm-2 control-label" for="input-sort_order' + mrp_row +'"><?php echo $entry_sort_order; ?></label>';
html += ' 			<div class="col-sm-4"><input type="text" name="product_mrp[' + mrp_row + '][sort_order]" value="" class="form-control" /></div>';
html += '		</div><div class="form-group"></div>';
html += '		<table id="products' + mrp_row +'" class="table table-striped table-bordered table-hover">';
html += '		  <thead>';
html += '			<tr>';
html += '			  <td class="text-left"><?php echo $entry_table_product; ?></td>';
html += '			  <td style="width: 10%;"><?php echo $entry_sorted; ?></td>';
...
html += '			  <td class="text-left"><button type="button" onclick="addmrpbox(' + mrp_row +');" data-toggle="tooltip" title="<?php echo $entry_add_table; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>';
html += '			</tr>';
html += '		  </tfoot>';
html += '		</table>';
html += '</div>';

$('#tab-mrp .tab-info').append(html);

<?php if ($ckeditor) { ?>
	<?php foreach ($languages as $language) { ?>
	ckeditorInit('input-description' + mrp_row + '-language<?php echo $language['language_id']; ?>', getURLVar('token'));
	<?php } ?>
	
<?php } else { ?>
	<?php foreach ($languages as $language) { ?>
	$('#input-description' + mrp_row + '-language<?php echo $language['language_id']; ?>').summernote({
	height: 150
	});
	<?php } ?>
<?php } ?>

$('#mrp-language' + mrp_row + ' li:first-child a').tab('show');
$('#mrptab-add').before('<li><a href="#tab-mrptab' + mrp_row + '" data-toggle="tab"><i class="fa fa-minus-circle" onclick="$(\'a[href=\\\'#tab-mrptab' + mrp_row + '\\\']\').parent().remove(); $(\'#tab-mrptab' + mrp_row + '\').remove(); $(\'#mrptab li a:first\').tab(\'show\');"></i> <?php echo $entry_group; ?> ' + mrp_row + '</a></li>');
$('#mrptab a[href=\'#tab-mrptab' + mrp_row + '\']').tab('show');
$('#mrptab-' + mrp_row).trigger('click');
...
<?php if ($ckeditor) { ?>
	...
	<?php foreach ($product_mrps as $product_mrp) { ?>
		<?php foreach ($languages as $language) { ?>
		ckeditorInit('input-description<?php echo $mrp_row; ?>-language<?php echo $language['language_id']; ?>', getURLVar('token'));
		<?php } ?>
	<?php $mrp_row++; ?>
	<?php } ?>
<?php } ?>
...
//--></script> 
<script type="text/javascript"><!--
var mrp_prod_row = <?php echo $mrp_prod_row; ?>;

function addmrpbox(mrp_row) {
html  = '<tr id="mrpbox-row' + mrp_prod_row + '">';
html += '  <td class="text-right"><input type="hidden" name="product_mrp[' + mrp_row + '][product_mrp_product][' + mrp_prod_row + '][related_id]" value="" placeholder="<?php echo $entry_table_product; ?>" class="form-control" /><input type="text" name="product_mrp[' + mrp_row + '][product_mrp_product][' + mrp_prod_row + '][product_name]" value="" placeholder="<?php echo $entry_table_product; ?>" class="form-control" /></td>';
html += '  <td class="text-left"><input type="text" name="product_mrp[' + mrp_row + '][product_mrp_product][' + mrp_prod_row + '][sort_order]" value="" id="input-mrpbox' + mrp_prod_row + '"  class="form-control text-center"/></td>';
html += '  <td class="text-left"><button type="button" onclick="$(\'#mrpbox-row' + mrp_prod_row  + '\').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
html += '</tr>';

$('#tab-mrptab' + mrp_row + ' tbody').append(html);

mrp_prod_row++;
}
//--></script> 
<script type="text/javascript"><!--
$('#mrptab li:first-child a').tab('show');
<?php $mrp_row = 1; ?>
<?php foreach ($product_mrps as $product_mrp) { ?>
$('#mrp-language<?php echo $mrp_row; ?> li:first-child a').tab('show');
<?php $mrp_row++; ?>
<?php } ?> 
//--></script>
<script type="text/javascript"><!--
$(document).delegate('input[name$=\'\[product_name\]\']', 'focus', function(){
  $('input[name$=\'\[product_name\]\']').autocomplete({
    ...
    'select': function(item) {
      $(this).val(item['label']);
      $(this).siblings($('input[name$=\'[product_id\]\']')).val(item['value']);
    }
  });
});
//--></script>
