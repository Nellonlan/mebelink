...
class ControllerFeedOcextFeedGeneratorYaMarket extends Controller {
	...
	private $eol = "\n";
                    ...
                    if(isset($general_setting['filter_data'])){
                        ...
                        foreach ($general_setting['filter_data'] as $filter_data) {
                            ...
                            if($filter_data['path_token_export']==$token_get){
                                ...
                                if(!isset($general_setting['content_language_id']) || !$general_setting['content_language_id']){
        ...
        public function getOfferAttrubite($product) {
            ...
            $data['url'] = $this->url->link('product/product', 'path='.$this->getPathWhisCategories($product['category_id']).'&product_id='.$product['product_id'].$product['option_url_param']);
            ...
            if(isset($template_setting['zero_price']) && !$template_setting['zero_price'] && $data['price']==0){
                $skip_this_offer = TRUE;
            }
        ...
        public function getCategoriesAndOffers($filter_data_group_id,$content_language_id) {
            ...
            $all_yml_export_ocext_ym_filter_data_categories = $this->model_feed_ocext_feed_generator_yamarket->getFilterData('ocext_feed_generator_yamarket_ym_filter_category',$filter_data_group_id);
            ...
            $all_yml_export_ocext_ym_filter_data_manufacturers = $this->model_feed_ocext_feed_generator_yamarket->getFilterData('ocext_feed_generator_yamarket_ym_filter_manufacturers',$filter_data_group_id);
            ...
            $this->load->model('feed/ocext_feed_generator_yamarket');
            $categories_and_products = $this->model_feed_ocext_feed_generator_yamarket->getCategoriesAndProducts($ym_categories,$ym_manufacturers,$filter_data_group_id,$content_language_id);
