...
$_['text_new_greeting']         = 'Благодарим Вас за обращение в наш магазин "Мебель доступная каждому". В ближайщее время с Вами свяжется менеджер для подтверждения заказа.';
