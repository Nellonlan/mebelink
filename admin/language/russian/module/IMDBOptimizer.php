...
// Heading
$_['heading_title']       = '<i class="fa fa-cloud-download fa-fw" style="color:#0362B6;margin-right:5px"></i>IMDBOptimizer';
$_['curr_heading_title']       = 'IMDBOptimizer - Оптимизация базы данных';
$_['heading_title_h1']       = 'IMDBOptimizer - Оптимизация базы данных';
// Text
$_['text_module']         = 'Модули';
$_['text_success']        = 'Модуль IMDBOptimizer успешно обновлен!';
...
// Error
$_['error_permission']    = 'У Вас нет прав для изменения модуля IMDBOptimizer!';
