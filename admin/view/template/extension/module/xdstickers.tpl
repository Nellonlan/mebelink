										...
										<tbody>
											...
											<?php foreach ($custom_xdstickers as $custom_xdsticker) { ?>
												<tr id="custom_xdsticker-row<?php echo $custom_xdsticker['xdsticker_id']; ?>">
													...
													<td class="text-left" style="width: 20%;">
														<input type="text" name="custom_xdsticker[<?php echo $custom_xdsticker['xdsticker_id']; ?>][name]" value="<?php echo $custom_xdsticker['name']; ?>" placeholder="<?php echo $entry_custom_xdstickers_title; ?>" class="form-control" />
													</td>
													<td class="text-left" style="width: 25%;">
														<?php foreach ($languages as $language) { ?>
