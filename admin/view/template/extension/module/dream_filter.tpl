    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <?php if($apply) { ?>
                    <button id="apply-button" type="button" data-url="<?= html_entity_decode($apply) ?>" data-form="form-rdrf" data-toggle="tooltip" data-loading-text="<i class='fa fa-refresh fa-spin'></i>" title="<?= $language['button_apply']; ?>"
    ...
    <div id="module-container" class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form-rdrf"
...
$(document).on("click", "button.open-toggle", function(e) {
    if($(this).data("open")) {
...
$(document).on("click", "#reset-toggle", function(e) {
    var button = $(this),
...
<script type="text/javascript">
    ...
    $(document).on('shown.bs.tab', 'a[href="#ajax"]', function (e) {
        editor1.refresh();
        editor2.refresh();
    });
