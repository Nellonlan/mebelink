            ...
            <tr>
                ...
                <td>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        ?>
                        <tr>
                            <td><input type="text" value="<?php echo $cost ?>" name="setting[delivery-options][<?php echo $i ?>][cost]" class="form-control" /></td>
                            <td><input type="text" value="<?php echo $days ?>" name="setting[delivery-options][<?php echo $i ?>][days]" class="form-control" /></td>
                            <td><input type="text" value="<?php echo $order_before ?>" name="setting[delivery-options][<?php echo $i ?>][order-before]" class="form-control" /></td>
                        </tr>
                        <?php } ?> 
                    </table>
                    </div>
